...
function barSeriesInit(barData, step, color0, color1) {
  const ret = [];
  const startR = color0.length === 7 ? Number.parseInt(color0.substr(1, 2), 16) : Number.parseInt(color0.substr(1, 1) + color0.substr(1, 1), 16);
  const startG = color0.length === 7 ? Number.parseInt(color0.substr(3, 2), 16) : Number.parseInt(color0.substr(2, 1) + color0.substr(2, 1), 16);
  const startB = color0.length === 7 ? Number.parseInt(color0.substr(3, 2), 16) : Number.parseInt(color0.substr(2, 1) + color0.substr(2, 1), 16);
  const endR = color1.length === 7 ? Number.parseInt(color1.substr(1, 2), 16) : Number.parseInt(color1.substr(1, 1) + color1.substr(1, 1), 16);
  const endG = color1.length === 7 ? Number.parseInt(color1.substr(3, 2), 16) : Number.parseInt(color1.substr(2, 1) + color1.substr(2, 1), 16);
  const endB = color1.length === 7 ? Number.parseInt(color1.substr(3, 2), 16) : Number.parseInt(color1.substr(2, 1) + color1.substr(2, 1), 16);
  const distanceR = endR - startR;
  const distanceG = endG - startG;
  const distanceB = endB - startB;

  const stepData = barData.map((item) => {
    return {
