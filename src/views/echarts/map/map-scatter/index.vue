  ...
  return {
    ...
    series: [
      ...
      },
      {
        ...
        symbolSize: (val) => {
          return (
            Number.parseInt(((val[2] - minVal) * (maxSymbolSize - minSymbolSize)) / (maxVal - minVal))
            + minSymbolSize
          );
        },
        label: {
...
.my-map-tooltip {
  ...
  width: 312px;
  height: 260px;
  background-image: linear-gradient(206deg, rgba(11, 41, 86, 0.95) 0%, rgba(2, 43, 84, 0.7) 95%);
  ...
  .tooltip-title {
    ...
    color: #ffffff;
    letter-spacing: 0;
    text-shadow: 0 0 4px rgba(82, 191, 254, 0.5);
    font-weight: 700;
  }
  ...
  .tooltip-list-content {
    ...
    .tooltip-list-item {
      ...
      border-radius: 3px;
      background-image:
        linear-gradient(180deg, rgba(70, 143, 250, 0) 55%, rgba(87, 136, 255, 0.12) 100%),
        linear-gradient(11deg, rgba(255, 165, 34, 0.2) 0%, rgba(51, 109, 255, 0) 44%),
        radial-gradient(circle at 97% 88%, rgba(100, 167, 252, 0.24) 0%, rgba(51, 87, 170, 0) 100%),
        linear-gradient(180deg, rgba(123, 179, 255, 0) 0%, rgba(69, 152, 255, 0.12) 99%);
